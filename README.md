...
- **궁극기 사용 방식**(정해진 턴 / 정해진 턴만 / 준비되면 바로)과 **연동(궁 맞추기)** 은 행동 고급 설정의 탭으로 옮겨져 제단과 무관하게 항상 쓸 수 있습니다(v1.8.3). 연동 멤버는 ‘같이 궁’ 외에 **‘방어/평타 → 앵커가 준 추가 행동에서 궁’**(예: 마타야 방어 → 욱영 궁 → 마타야 궁)을 고를 수 있습니다. 우선순위는 **턴별 타임라인이 1순위, 연동·사용 방식이 2순위**입니다.
