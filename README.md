...
매 턴 아군 전체가 **최대 HP의 일정 %**만큼 피해를 받게 합니다. 자기 HP에 반응하는 캐릭터(무명 등)의 실전 성능 검증용입니다.

- 적 페이즈가 끝날 때 적용되며, **배리어가 먼저 흡수**하고 방어한 턴은 절반만 받습니다. 받는 데미지 증감도 반영되고, 아군은 체력 1 미만으로 내려가지 않습니다.
