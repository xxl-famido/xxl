...
- 제단으로 필살기 쿨타임이 달라질 수 있어, 켜면 캐릭터 창에 **궁극기 사용 방식**(정해진 턴 / 정해진 턴만 / 준비되면 바로)이 나타납니다.
- 패널 아래 **궁극기 맞추기**로 서포터를 메인 딜러의 필살기 턴에 맞출 수 있습니다(최대 3그룹). 우선순위는 **행동 고급 설정이 1순위, 궁극기 맞추기·사용 방식이 2순위**입니다.
